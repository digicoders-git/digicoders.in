...
<head>
    ...
    <title><?= $service_name ?> | Development Services - DigiCoders</title>
...
<body>
    ...
    <section class="banner">
        ...
        <div class="banner-content">
            <h1><?= strtoupper($service_name) ?> SERVICES IN <?= strtoupper($city_name) ?></h1>
    ...
    <div class="city-courses-section">
        <div class="city-container">
            ...
            <div class="city-header">
                <h1>DigiCoders Software <?= strtoupper($service_name) ?> Services in <span><?= $city_name ?></span></h1>
                        ...
                        <div class="services-grid">
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-description">
                                        ...
                                        receiving payment. An individual reach is limited but an effective website can
                                        reach
                                        beyond the expectation. We offer you a complete ecommerce website development
                                        and
                                        best SEO services considering the user perspective to offer complete
                                        satisfaction.
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-description">
                                        ...
                                        for
                                        mobile devices. We create native and hybrid mobile applications for iOS and
                                        Android
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-description">
                                        Domain name is the first face of a business when we talk digitally. Web hosting
                                        is a
                                        service that allows organizations and individuals to post a website or web page
                                        onto
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-description">
                                        ERP is an acronym for Enterprise Resource Planning. We develop custom ERP and
                                        CRM
                                        solutions that integrate all facets of your business operations including
                                        planning,
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-description">
                                        Leverage our powerful software maintenance and support services around the
                                        globe, as
