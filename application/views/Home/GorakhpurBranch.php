...
<head>
    <title>Gorakhpur Branch | DigiCoders Technologies Pvt. Ltd.</title>
    <meta name="description"
        content="Our Gorakhpur branch is committed to delivering innovative digital solutions and exceptional IT services to businesses across Gorakhpur and nearby regions.">
    <?php include('include/headerlinks.php') ?>

    <style>
        /* ==========================================================================
           100% Exact Match Styling for Gorakhpur Branch Page
           ========================================================================== */
        ...
        /* 1. Hero Section Edge-to-Edge Right Image */
        .gorakhpur-hero-sec {
        ...
        .gorakhpur-hero-overlay {
            position: absolute !important;
            top: 0 !important;
            left: 0 !important;
            right: 0 !important;
            bottom: 0 !important;
            background: linear-gradient(90deg, #07221a 0%, #07221a 42%, rgba(7, 34, 26, 0.85) 55%, rgba(7, 34, 26, 0.15) 85%, rgba(7, 34, 26, 0) 100%) !important;
            z-index: 2 !important;
        }

        .gorakhpur-breadcrumb {
            font-size: 13px;
            color: #94a3b8;
            margin-bottom: 22px;
            display: flex;
        ...
        .gorakhpur-breadcrumb a {
            color: #cbd5e1;
            text-decoration: none;
        }

        .gorakhpur-breadcrumb a:hover {
            color: #10b981;
        }

        .gorakhpur-hero-title {
        ...
        .gorakhpur-badges-bar {
            background: rgba(4, 28, 21, 0.85) !important;
...
<body>
    ...
    <!-- 1. HERO SECTION (100% Exact Match to User Reference Screenshot) -->
    <style>
        .exact-gorakhpur-hero {
            position: relative !important;
        ...
        .exact-hero-wave-overlay {
            position: absolute !important;
            top: 0 !important;
            left: 0 !important;
            right: 0 !important;
            bottom: 0 !important;
            background: linear-gradient(90deg, #dcefe3 0%, #dcefe3 38%, rgba(220, 239, 227, 0.92) 48%, rgba(220, 239, 227, 0.45) 62%, rgba(220, 239, 227, 0) 80%) !important;
            z-index: 2 !important;
        }

        .exact-hero-orange-accent {
            position: absolute !important;
            bottom: -60px !important;
            right: -40px !important;
            width: 220px !important;
            height: 180px !important;
            background: radial-gradient(circle, #d97706 0%, #b45309 80%) !important;
            border-radius: 50% !important;
            z-index: 3 !important;
            opacity: 0.85 !important;
        }

        .exact-hero-breadcrumb {
        ...
        .exact-hero-breadcrumb a {
            color: #64748b !important;
            text-decoration: none !important;
        }

        .exact-hero-breadcrumb i {
            font-size: 8px !important;
            color: #94a3b8 !important;
        }

        .exact-hero-breadcrumb .active-crumb {
        ...
        .exact-hero-title .highlight-green {
            color: #046a38 !important;
        }
        ...
        .exact-branch-item:last-child {
            margin-bottom: 0 !important;
        }

        .exact-branch-item.active {
            background: #046a38 !important;
            color: #ffffff !important;
            font-weight: 700 !important;
        }
    ...
    <!-- 1. HERO SECTION WITH EXACT GREEN CURVED RIBBON PARTITION & LIGHT THEME (MATCHING LUCKNOW & KANPUR) -->
    <section class="gorakhpur-hero-sec"
        style="position: relative; background: linear-gradient(135deg, #f8fafc 0%, #f0fdf4 45%, #e6f7ec 100%); padding: 50px 0 45px 0; min-height: 540px; overflow: hidden; display: flex; align-items: center;">

        <!-- Ambient Background Orbs (Hidden on Mobile/Tablet) -->
        <div class="d-none d-lg-block"
            style="position: absolute; top: -40px; left: -40px; width: 280px; height: 280px; background: radial-gradient(circle, rgba(16, 185, 129, 0.25) 0%, rgba(4, 106, 56, 0.08) 50%, rgba(255, 255, 255, 0) 70%); border-radius: 50%; z-index: 2; pointer-events: none;">
        </div>
        <div class="d-none d-lg-block"
            style="position: absolute; bottom: -50px; left: 180px; width: 260px; height: 260px; background: radial-gradient(circle, rgba(249, 115, 22, 0.2) 0%, rgba(234, 88, 12, 0.05) 50%, rgba(255, 255, 255, 0) 70%); border-radius: 50%; z-index: 2; pointer-events: none;">
        </div>
        ...
        <div class="d-none d-lg-flex"
            ...
            <img src="<?= base_url('public/assets/images/gorakhpur_hero_dashboard.png') ?>"
                alt="DigiCoders Gorakhpur Software Development & IT Services"
        ...
        <svg class="d-none d-lg-block"
            ...
            <defs>
                <linearGradient id="gorakhpurGreenRibbonGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <path d="M 20,0 Q 180,400 20,800 L 70,800 Q 230,400 70,0 Z" fill="url(#gorakhpurGreenRibbonGrad)" />
        </svg>

        <div class="container position-relative" style="z-index: 5;">
            <div class="row align-items-center">
                <!-- Left Side Content (Strictly Restricted to col-lg-5 max-width: 480px) -->
                <div class="col-lg-5 col-md-12" style="max-width: 480px;">
                    ...
                    <div
                        ...
                        <i class="fas fa-chevron-right" style="font-size: 10px;"></i>
                        <span style="color: #046a38; font-weight: 600;">Gorakhpur</span>
                    </div>
                    ...
                    <h1 style="font-size: 38px; font-weight: 800; color: #0f172a; line-height: 1.2; margin-bottom: 6px; letter-spacing: -0.5px;"
                        ...
                        Gorakhpur <span style="color: #046a38;">Branch</span>
                    </h1>
                    ...
                    <p
                        ...
                        Our Gorakhpur branch is committed to delivering innovative digital solutions and exceptional IT
                        services to businesses across Gorakhpur and nearby regions.
                    </p>
                    ...
                    <ul
                        ...
                        <li
                            ...
                            <span>INSIDE MAIN BUILDING, BUDDHA INSTITUTE OF TECHNOLOGY, CL-1, SECTOR-7, GIDA, GORAKHPUR,
                                UP, 273209</span>
                        </li>
                        <li
                            style="display: flex; align-items: center; gap: 12px; font-size: 13.5px; color: #1e293b; font-weight: 600;">
                ...
                <div class="col-lg-7 col-md-12 d-lg-none mt-4">
                    <div
                        ...
                        <img src="<?= base_url('public/assets/images/gorakhpur_hero_dashboard.png') ?>"
                            alt="DigiCoders Gorakhpur IT Services"
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-12 mb-4 mb-lg-0">
                    ...
                    <p class="gorakhpur-about-p">
                        Our Gorakhpur branch empowers businesses with cutting-edge IT solutions, including web
                        development, mobile app development and digital marketing services.
                    </p>
                    <p class="gorakhpur-about-p">
                        We focus on building long-term relationships and delivering value through technology and
                        innovation.
                    </p>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-md-6 col-6 mb-3 mb-lg-0">
                            <div class="stat-card-box">
                                ...
                                <h3 class="stat-num-val">4+</h3>
                                <p class="stat-label-text">Years in Gorakhpur</p>
                            </div>
                        </div>
    ...
    <!-- 3. OUR SERVICES IN GORAKHPUR -->
    <section class="sec-padding" style="background: #ffffff;">
        <div class="container-fluid" style="max-width: 1320px;">
            <div class="text-center mb-5">
                <h2 class="gorakhpur-sec-heading"
                    style="font-size: 32px !important; font-weight: 800 !important; margin-bottom: 6px !important;">
                    Our Services <span style="color: #046a38;">in Gorakhpur</span>
                </h2>
                <div
                    style="width: 32px; height: 3.5px; background: #f97316; border-radius: 2px; margin: 0 auto 30px auto;">
                </div>
            </div>
            ...
            <div class="row row-cols-lg-5 row-cols-md-3 row-cols-1 g-3">
                ...
                <div class="col mb-3">
                    <div class="service-card-item"
                        style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 24px 20px; height: 100%; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);"
