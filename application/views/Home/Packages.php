...
<head>
    ...
    <meta name="description"
        content="Our website development packages are affordable and you can find them on our website.">
                    ...
                    <div class="row pricing-table-one">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular wow move-up">
                            <div class="pricing-table__inner">
                                ...
                                <div class="pricing-table__body">
                                    <div class="pricing-table__footer">
                                        <a href="<?= base_url() ?>/Home/RequestProposal" class="ht-btn  ht-btn-md ">Get
                                            this Offer!</a>
                                    </div>
                                    <ul class="pricing-table__list text-left">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 col-lg-7">
                        <div class="cta-content md-text-center">
                            <h3 class="heading text-white">Assess your business potentials and find opportunities <span
                                    class="text-color-secondary">for bigger success</span></h3>
                        </div>
                    </div>
