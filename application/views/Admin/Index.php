            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6">
                <div class="card-body p-4 p-sm-5">
                  ...
                  <form class="form-body" action="<?= base_url('Authentication/AdminLogin/Authenticate') ?>" method="post" id="auth-form">
				    <?php
$csrf = array(
...
<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                    <div class="d-grid">
                       <!--<a class="btn btn-white radius-30" href="javascript:;"><span class="d-flex justify-content-center align-items-center">
                         <img class="me-2" src="<?= base_url('public') ?>/app-assets/images/icons/search.svg" width="16" alt="">
