...
<head>
    <title>Proposal Request List - <?= $this->data['app_name'] ?></title>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">All Proposal Request List</div>
                <div class="ps-3">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col">
                                                <div class="btn-group">
                                                    <button type="button" onclick="delData(<?= $data->id ?>,'proposal_req','<?= base_url('Admin/Delete') ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></button>
