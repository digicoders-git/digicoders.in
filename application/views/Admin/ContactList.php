    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> Contact List</div>
                <div class="ps-3">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col">
                                                <div class="btn-group">
                                                <button type="button" onclick="delData(<?= $data->id ?>,'contact','<?= base_url('Admin/Delete') ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></button>
                                                    <!-- <button type="button" onclick="EditData('contact',<?= $data->id?>,'Edit Contact')" class="btn btn-primary"><i class="bi bi-pencil-square"></i></button> -->
                                                </div>
                                            </div>
                                        </td>
