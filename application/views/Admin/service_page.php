...
<head>
    <title>Service/City Pages - <?= $this->data['app_name'] ?></title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Service/City Page</div>
                <div class="ps-3">
            ...
            <div class="card">
                <div class="card-header py-3">
                    <div class="row align-items-center m-0">
                        <div class="col-sm-6">
                            <h6>Manage Service/City Pages</h6>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <div class="btn-group">
                                                        <button type="button"
                                                            onclick="delData(<?= $data->id ?>,'seo_pages','<?= base_url('Admin/Delete') ?>')"
    ...
    <div class="modal fade" id="CourseCityModal" tabindex="-1" aria-labelledby="courseCityModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="courseCityModalLabel">Add Service/City Page</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?= base_url() ?>Admin/addpage" method="POST" id="service-city-form">
                    <div class="modal-body">
                        <?php
                        $csrf = array(
                            'name' => $this->security->get_csrf_token_name(),
