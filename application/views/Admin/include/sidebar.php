<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="<?= base_url('public') ?>/assets/images/DigiCoders Transparent Logo.png" class="logo-icon" alt="logo icon"
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="<?= base_url() ?>Admin/ManageJob" class="">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('jobs')->num_rows(); ?></center>
                </span>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?= base_url('Admin/ManageProject') ?>">
                        <i class="bi bi-circle"></i><span>All Projects</span>
                        &nbsp&nbsp<span class="badge badge-secondary" style="background-color:red; border-radius:5px;">
                            <?= $this->db->get('projects')->num_rows(); ?>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('Admin/ManageProjectEnquiries') ?>">
                        <i class="bi bi-circle"></i><span>Project Enquiries</span>
                        &nbsp&nbsp<span class="badge badge-secondary" style="background-color:red; border-radius:5px;">
                            <?= $this->db->get('project_enquiries')->num_rows(); ?>
                        </span>
                    </a>
                </li>
            </ul>
        ...
        <li>
            <a href="<?= base_url() ?>Admin/ManageBlog" class="">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('blog')->num_rows(); ?></center>
                </span>
        ...
        <li>
            <a class="" href="<?= base_url() ?>Admin/servicepage">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('seo_pages')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageSlider">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('slider')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageContact">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('contact')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageCareer">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('career')->num_rows(); ?></center>
                </span>
            </a>
        ...
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageCallBackReq">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('call_request')->num_rows(); ?></center>
                </span>
            </a>
        ...
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageClient">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('client')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/OurProduct">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('productcost')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Software Products</div>
            </a>
            <ul>
                <li>
                    <a href="<?= base_url('AdminSoftware/index') ?>">
                        <i class="bi bi-circle"></i><span>All Softwares</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('AdminSoftware/demo_requests') ?>">
                        <i class="bi bi-circle"></i><span>Demo Requests</span>
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageExpertList">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('expert')->num_rows(); ?></center>
                </span>
            </a>
        ...
        <li>
            <a class="" href="<?= base_url() ?>Admin/Manageintern">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('intern')->num_rows(); ?></center>
                </span>
            </a>
        ...
        <li>
            <a href="<?= base_url() ?>Admin/ManageEnquiry">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('quick_enquiry')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a href="<?= base_url() ?>Admin/ManageProposalReq">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('proposal_req')->num_rows(); ?></center>
                </span>
            </a>
        </li>
        <li>
            <a class="" href="<?= base_url() ?>Admin/ManageNews">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('news')->num_rows(); ?></center>
                </span>
            </a>
        ...
        <li>
            <a href="<?= base_url() ?>Admin/ManageGallery">
                ...
                &nbsp&nbsp<span class="badge badge-secondary"
                    style="background-color:red; border-radius:5px; padding-right:15px">
                    <center class="menu-title"><?= $data = $this->db->get('gallery')->num_rows(); ?></center>
                </span>
            </a>
        </li>
